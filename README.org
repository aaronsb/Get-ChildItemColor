...
- [[https://github.com/aaronsb][Aaron Bockelie]]
* Changelog
** v3.0.0
- Moved modules 1:1 to file structure reflecting public and private components
- All dotsourcing comes from master module file
- Export of functions managed specifically from module definition.
** v2.3.0
- Externalized configuration files to json dictionaries
- Recursive processing of file types and color mappings is now allowed
- If no json color templates exist in $profile directory, copy default template files to $profile
- Reload colors after editing json with Get-ChildItemColorTable
** v2.2.0
